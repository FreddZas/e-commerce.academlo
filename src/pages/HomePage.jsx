...
const HomePage = () => {
  ...
  const products = useSelector(reducer => reducer.products) // El useSelector va al Store y busca el estado global
      ...
      <div className="product-container">
        {
          products?.filter(cbFilter).length === 0
            ? <h2>Sorry😭, can't show any products with that prices ❌</h2>
